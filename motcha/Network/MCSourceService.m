...
- (void) hardCodeSource {
  ...
  //Hardcoded MCSource
  MCSource * technologySource1 = [[MCSource alloc] initWithCategory:@"technology"
                                                            source:@"cnet"
                                                              link:@"www.cnet.com/rss/news/"
                                                         needParse:NO
                                                       fullTextale:YES];
  
  MCSource * technologySource2 = [[MCSource alloc] initWithCategory:@"technology"
                                                             source:@"engadget"
  ...
  MCSource * financeSource = [[MCSource alloc] initWithCategory:@"finance"
                                                         source:@"economist"
  ...
  MCSource * artsSource = [[MCSource alloc] initWithCategory:@"arts"
                                                      source:@"artnews"
